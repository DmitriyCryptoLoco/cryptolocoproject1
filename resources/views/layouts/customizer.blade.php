                    ...
                    <div class="layouts">
                        ...
                        <div class="layout-box mb-4 {{ Session::get('layout') == 'compact' ? 'active' : '' }}">
                            <a href="{{route('compact')}}">
                                <img alt="" src="{{ asset('assets/images/screenshots/02_preview.png') }}"/><i
                                        class="i-Eye"></i>
                            </a>
                        </div>
                        <div
                            ...
                            <a href="{{route('normal')}}">
                                <img alt="" src="{{ asset('assets/images/screenshots/04_preview.png') }}"/><i
                                        class="i-Eye"></i>
                            </a>
                        </div>
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                            <div class="colors sidebar-colors">
                                <a class="color gradient-purple-indigo"
