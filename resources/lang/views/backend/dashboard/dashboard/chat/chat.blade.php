...
@section('main-content')
    <div data-sidebar-container="chat" id="chat-container" class="card chat-sidebar-container">
        ...
        <div data-sidebar-content="chat" class="chat-content-wrap">
            ...
            <div class="pl-3 pr-3 pt-3 pb-3 box-shadow-1 chat-input-area">
                <form class="inputForm" action="send/message">
            ...
            <script>
                ...
                var pusher = new Pusher('319b279763691c8cac50', {
                    cluster: 'eu',
                    forceTLS: true
                });
