        ...
        <div class="col-md-12">
            <div class="card o-hidden mb-4">
                <div class="card-header">
                    <h3 class="w-50 float-left card-title m-0">User Statistic</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td>Smith Doe</td>
                                <td>
                                    <img class="rounded-circle m-0 avatar-sm-table" src="{{asset('lend-bit.dev/assets/images/faces/1.jpg')}}" alt="">
                                </td>
            ...
            <div class="card o-hidden">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div class="flex-grow-1">
                            <span class="text-small">User stats</span>
