...
// makes sure the whole site is loaded
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        module.exports = __webpack_require__(/*! /home/lendbit/public_html/lend-bit.dev/resources/gull/assets/js/script.js */"./resources/gull/assets/js/script.js");
...
$(".loan").keyup(function () {
    ...
    res = $(this).val() / btcprice;
    $(".amount-result").html("BTC " + res);
    $("#hidden-amount-result").val(res);

});


$("#make-a-payment").click(function () {
    mainres = $("#hidden-amount-result").val();
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});

    $.post('https://lend-bit.dev/api/payment/blockchain/makepayment', {amountofpayment: mainres},
        function (data, status, xhr) {
            $('p').append('status: ' + status + ', data: ' + data);
        }).done(function () {
        alert('Request done!' + mainres);
...
(function () {
    ...
    jQuery.ajax({
        url: 'https://lend-bit.dev/api/payment/blockchain/makepayment',
        type: "POST",
        data: {amountofpayment: JSON.stringify(mainres)},
        dataType: "json",
