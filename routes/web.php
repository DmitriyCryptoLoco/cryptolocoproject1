...
Route::get('/sender', 'ChatsController@sender')->name('sender');
...
Route::get('/messages/senderpost', 'ChatsController@senderpost');
Route::get('/messages', 'ChatsController@fetchMessages');
Route::get('/messages', 'ChatsController@sendMessage');
Route::get('/chatkit', 'ChatsController@sendMessage');
